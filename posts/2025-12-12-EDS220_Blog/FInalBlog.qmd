---
title: Visualizing Fire Scars Through False Color Imagery
jupyter: eds220-env
---
...
A key step when working with spatial data is making sure the coordinate reference systems match for accurate spatial analysis when combining vector data (fire parameters, census tracts) with raster data (satellite imagery). 
