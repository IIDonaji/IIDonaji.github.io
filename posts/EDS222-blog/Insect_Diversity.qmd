...
Urban areas are expanding globally, yet we know little about how landscaping choices affect urban biodiversity. Cities are environmental gradients that consistently shape habitat quality and biodiversity [^1]. Los Angeles, a naturally arid Mediterranean climate, presents a unique opportunity to examine whether drought-tolerant landscaping supports insect diversity. Adams et al.(2020)[^2] sampled insects monthly at 30 sites across LA County in 2014, capturing variation in urbanization intensity and landscaping type, making it well-suited to test this question.

[^1]: Nancy B. Grimm et al.,(2008) Global Change and the Ecology of Cities.Science 319(5864),756-760.[DOI:10.1126/science.1150195](https://www.science.org/doi/10.1126/science.1150195)

[^2]: Adams, Benjamin et al.,(2020) Local and landscape scale variables shape insect diversity in an urban biodiversity hot spot 30(4).[DOI:e02089.10.1002/eap.2089](https://esajournals.onlinelibrary.wiley.com/doi/10.1002/eap.2089)
...
To estimate the *true effect* of drought-tolerant plants on species richness, we include both temperature and urbanization as covariates in the model. This accounts for the confounder and allows us to answer:
...
- Urbanization → Richness: Urbanization directly affects habitat quality.

- Drought Plants → Richness: Our main hypothesis (drought tolerant plants help insects).
...
**Scientific Hypothesis 2:** Local mean temperature is associated with insect species richness.
...
- **Temperature effect**: True $\beta_2$ = 0.08, Estimated $\beta_2$ = 0.076
...
![Figure 3 (facet by Urban Type): Predicted insect species richness as a function of mean temperature and drought-tolerant plant presence across urban type (1= natural, 9 = highly urbanized). Shaded bands represent 95% confidence intervals.](figs/main_plot.png)

![Figure 4 ( average across urban types): Predicted mean insect species richness across the observed temperature range for sites with (green) and without (orange) drought-tolerant plants. Lines show model predictions average across urban types; points are observed site-level data. Shaded bands represent 95% confidence intervals.](figs/simple_plot.png)

## Discussion

This results suggest a positive association between drought-tolerant landscaping and insect diversity, though the wide confidence intervals indicate uncertainty in the estimate.
